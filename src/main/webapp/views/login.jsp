<%-- 
    Document   : login
    Created on : ene 2, 2023, 11:22:47 a.m.
...
<main class="container d-flex justify-content-center align-items-center">
    ...
    <form method="POST" action="/showroombylu/usuario/loginUser" class="py-4 px-5 rounded" >
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/showroombylu/views/registro.jsp" class="link-primary">Registrarme</a>
            </div>
        </div>
    </form>
</main>
