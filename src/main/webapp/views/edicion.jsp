<%-- 
    Document   : edicion
    Created on : ene 2, 2023, 11:10:00 a.m.
...
<%
    if (!(boolean)session.getAttribute("isLogin")){
        response.sendRedirect("/showroombylu/");
    }
...
<main class="container d-flex justify-content-center align-items-center">
    ...
    <form method="POST" action="/showroombylu/usuario/updateUser" class="w-50 px-5 py-4 rounded" >
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/showroombylu/usuario/deleteUser" class="btn btn-danger">Eliminar</a>
            </div>
            <div class="col-auto">
                <a href="/showroombylu" class="link-primary">Inicio</a>
            </div>
        </div>
    </form>
</main>
