...
public class UsuarioDAO {
    ...
    public int createUser(Usuario u) throws SQLException {
        ...
        ps.setString(1, u.getUsername()); //unica manera de obtener el dato es con el getter porque las propiedades de usuario son privadas, no se podria poner u.Username
