        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            switch (action) {
                case "/loginUser":
                    ...
                    response.sendRedirect("/showroombylu/views/user.jsp");
                    break;
                ...
                case "/createUser":
                    ...
                    response.sendRedirect("/showroombylu/views/userCreado.jsp");
                    break;
                    
                case "/viewUser":
                    username = (String) session.getAttribute("actualUsername");
                    actualUser = (Usuario) udao.getUserByUsername(username);
                    
                    session.setAttribute("actualUser", actualUser);
                    response.sendRedirect("/showroombylu/views/edicion.jsp");
                    break;
